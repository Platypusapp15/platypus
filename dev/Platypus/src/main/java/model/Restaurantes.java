...
public class Restaurantes implements java.io.Serializable {
    ...
    public Restaurantes(Direcciones direcciones, RestaurantesTipos restaurantesTipos, Usuarios usuarios, String nombre, String descripcion, String emailCorporativo, Integer plazas, Date horaApertura, Date horaCierre, Integer telefono, String coordenadas, String imgUrl) {
        this.direcciones = direcciones;
        this.restaurantesTipos = restaurantesTipos;
        this.usuarios = usuarios;
        this.nombre = nombre;
