 ...
 */
@JsonIgnoreProperties(value = {"comentarioses", "comentariosLikeses"})
public class Comentarios implements java.io.Serializable {
    ...
    public Comentarios(Comentarios comentarios, Restaurantes restaurantes, Usuarios usuarios, String comentario, Date fechaHora) {
