...
public class TestService {
    ...
    private Direcciones direccion1 = new Direcciones("Barcelona", "Barcelona", "08032", "EspaÃ±a");
    private Direcciones direccion2 = new Direcciones("Mataro", "Barcelona", "08932", "EspaÃ±a");
    private Direcciones direccion3 = new Direcciones("Gerona", "Gerona", "09532", "EspaÃ±a");
    ...
    private Usuarios usu1 = new Usuarios(direccion1, rango1, tipoUsu1, "seix@live.com", "password", "IvÃ¡n", "Mesa", "MartÃ­n", "Hombre", d1, 1F, 0, null, null, null, null, null, null, null);
    private Usuarios usu2 = new Usuarios(direccion2, rango2, tipoUsu2, "pepe@live.com", "password", "Pepe", "Mesa", "MartÃ­n", "Hombre", d2, 1F, 0, null, null, null, null, null, null, null);
    private Usuarios usu3 = new Usuarios(direccion3, rango1, tipoUsu3, "chef@live.com", "password", "Chef", "De", "Restaurante", "Mujer", d3, 1F, 0, null, null, null, null, null, null, null);

    private Restaurantes rest1 = new Restaurantes(direccion2, tipoRest1, usu3, "Can RamÃ³n", "Con terraza interior y 75 plazas", "canramon@gmail.com", 75, d3, d3, 934258712, null, null, null, null, null);
    ...
    public boolean testDatabase() {
        ...
        try {
            ...
            System.out.println("\nUna operaciÃ³n no se ha completado correctamente");
            correcto = false;
            session.close();
        }
